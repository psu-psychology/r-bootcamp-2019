...
## shape
```{r shape}
# Error: Continuous value supplied to discrete scale - not sure what is happening here - Need to go in and factor sex
...
plot +
  labs(color = "sex",
       title = "Relationship between SATQ and SATV by sex and education",
