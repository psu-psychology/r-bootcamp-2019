...
There are much easier and reproducible ways to do things in R right from the comfort of your project's working directory.
...
Or we can assign `110010` to the *character* `2`, `101011` to the *character* `+`, `111101` to the `=` character, and `110100` to the *character* `4`. This let's the computer use: `110010` `101011` `110010` `111101` `110100` to represent `2+2=4`.
