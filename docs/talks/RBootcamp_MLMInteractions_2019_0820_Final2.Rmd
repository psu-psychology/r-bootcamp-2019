...
We make use of the `lme4` package for fitting mixed effects models, and some supplmentary packages: `lmerTest` provides tools for obtaining p-values; `effects` provides tools for calculating and plotting model-based predictions; and `interactions` provides tools for plotting and probing interactions.
